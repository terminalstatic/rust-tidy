...
pub struct _TidyAllocatorVtbl {
    pub alloc: ::std::option::Option<
        unsafe extern "C" fn(self_: *mut TidyAllocator, nBytes: size_t) -> *mut ::std::os::raw::c_void,
    >,
    ...
    >,
    pub free:
        ::std::option::Option<unsafe extern "C" fn(self_: *mut TidyAllocator, block: *mut ::std::os::raw::c_void)>,
...
pub type TidyRealloc = ::std::option::Option<
    unsafe extern "C" fn(buf: *mut ::std::os::raw::c_void, len: size_t) -> *mut ::std::os::raw::c_void,
>;
...
#[doc = "         option, or `no` if it does not. In the latter case, Tidy will issue"]
#[doc = "         an unknown configuration option error."]
pub type TidyConfigCallback =
    ::std::option::Option<unsafe extern "C" fn(tdoc: TidyDoc, option: ctmbstr, value: ctmbstr) -> Bool>;
extern "C" {
    #[doc = " Applications using TidyLib may want to augment command-line and"]
    #[doc = " configuration file options. Setting this callback allows a LibTidy"]
    #[doc = " application developer to examine command-line and configuration file options"]
...
pub type TidyGetByteFunc =
    ::std::option::Option<unsafe extern "C" fn(sourceData: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int>;
...
pub type TidyReportFilter = ::std::option::Option<
    unsafe extern "C" fn(tdoc: TidyDoc, lvl: TidyReportLevel, line: uint, col: uint, mssg: ctmbstr) -> Bool,
>;
extern "C" {
...
pub type TidyPPProgress =
    ::std::option::Option<unsafe extern "C" fn(tdoc: TidyDoc, line: uint, col: uint, destLine: uint)>;
extern "C" {
